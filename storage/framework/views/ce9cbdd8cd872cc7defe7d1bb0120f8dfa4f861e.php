...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo e(url('lancer/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">

    <!-- Theme CSS -->
    <link href="<?php echo e(url('lancer/css/freelancer.min.css')); ?>" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="<?php echo e(url('lancer/vendor/font-awesome/css/font-awesome.min.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(url('https://fonts.googleapis.com/css?family=Montserrat:400,700')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(url('https://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic')); ?>" rel="stylesheet" type="text/css">
...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="<?php echo $__env->yieldContent('kategori'); ?>"><a href="<?php echo e(url('/kategori')); ?>">Kategori Lembur</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-text">
                        <span class="name">SMK ASSALAAM BANDUNG</span>
                        <hr class="star-light">
                        <span class="skills">ANDY RAY - XII RPL 2 - 141510172</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <a href="#" class="btn btn-lg btn-outline">
                        <i class="fa fa-upload"></i> Kembali Keatas
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="tel" class="form-control" placeholder="Nomor Handphone" id="phone" required data-validation-required-message="Please enter your phone number.">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="row control-group">
    ...
    <!-- jQuery -->
    <script src="<?php echo e(url('lancer/vendor/jquery/jquery.min.js')); ?>"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="<?php echo e(url('lancer/vendor/bootstrap/js/bootstrap.min.js')); ?>"></script>

    <!-- Plugin JavaScript -->
    <script src="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.3/jquery.easing.min.js')); ?>"></script>

    <!-- Contact Form JavaScript -->
    <script src="<?php echo e(url('lancer/js/jqBootstrapValidation.js')); ?>"></script>
    <script src="<?php echo e(url('js/contact_me.js')); ?>"></script>

    <!-- Theme JavaScript -->
    <script src="<?php echo e(url('js/freelancer.min.js')); ?>"></script>
